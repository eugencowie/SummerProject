...
namespace SummerProject
{
    ...
    /// based on the type.
    /// 
    /// The BasicScreenFactory type has the minimal implementation along with some extra comments
    /// showing a potentially more complex example of how to implement IScreenFactory.
    /// </summary>
