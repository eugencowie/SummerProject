...
{
    /// <summary>
    /// A basic implementation of IScreenFactory which can handle creating the screens
    /// when resuming from being tombstoned.
    /// </summary>
    public class BasicScreenFactory : IScreenFactory
    {
        public GameScreen CreateScreen(Type screenType)
        {
            // If our screens have empty constructors so we can just use Activator
